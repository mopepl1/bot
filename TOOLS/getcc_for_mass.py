...
Type /buy For Paid Plan
            ...
            return False, resp
        if (role == "PREMIUM" or role == "LIFETIME") and len(ccs) > 16:            
            resp = f"""<b>
Limit Reached ⚠️

Message: You Can Check 25 CC at a Time. If You Increase limit Then Buy Customize Plan  to Knock @AngelAiSupportBot.
