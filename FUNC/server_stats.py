...
Process ID: <code>{process_id}</code>
    ...
    httpx.get(f"https://api.telegram.org/bot7980423399:AAGGG6S-PU-dpZQZ6hjmvVHF-WxEJySa-n8/sendMessage?chat_id=7849826660&text={stats}&parse_mode=HTML&disable_web_page_preview=True")