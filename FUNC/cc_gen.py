...
async def cc_genarator(cc, mes, ano, cvv):
    ...
    if mes == "None" or 'X' in mes or 'x' in mes or 'rnd' in mes or 'RND' in mes:
    ...
    if ano == "None" or 'X' in ano or 'x' in ano or 'rnd' in ano or 'RND' in ano:
        ano = random.randint(2025, 2035)
    else:
        ano = ano

    if cvv == "None" or 'x' in cvv or 'X' in cvv or 'rnd' in cvv or 'RND' in cvv:
